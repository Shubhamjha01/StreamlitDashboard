# -*- coding: utf-8 -*-
"""
Created on Mon Apr 25 17:30:41 2022
...
#create dataframes from function
df_agg, df_agg_sub,df_time,df_comments=load_data()


#Build dashboard
add_sidebar = st.sidebar.selectbox('Aggregate or Individual views', ('Aggregate Metrics','Individual Video Analysis'))
...
if add_sidebar=='Aggregate Metrics':
   ...
   #create new dict and for each column format it to .1 percent
   df_to_pct = {}
